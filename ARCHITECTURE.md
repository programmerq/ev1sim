...
|------------|--------------|-----------------------------------------------------|
| 4000..4199 | chassis bus  | bulbs/horn (4000-4021), panel sensors (4030-4033), motor/throttle/brake/**sim-time** (4070-4075), wiper/HVAC/ambient (4080-4091), body-actuator peripherals — door-lock motor / sounder / steering pump (4092-4098, see [docs/peripherals.md](docs/peripherals.md)), HVAC driver controls → HTCM (4124-4128), IPC telltales (4130-4145), BTCM actuators (4147-4154) |
